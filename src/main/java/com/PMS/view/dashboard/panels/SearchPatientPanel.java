...
/*
 * SearchPatientPanel:
 * Provides the user interface for searching a patient by ID.
 * Displays patient details such as name, age, gender, city,
 * height, weight, BMI, and BMI category after a successful search.
 */
public class SearchPatientPanel extends JPanel {
    ...
    private void initialize(){
        ...
        heading = new JLabel("Search Patient by ID");
        ...
        searchBtn.setBounds(290, 405, 130, 40);
        add(searchBtn);
    ...
    // Returns Search button reference
